 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.pascal.structured_statement#getCompound_statement <em>Compound statement</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.pascal.structured_statement#getRepetitive_statement <em>Repetitive statement</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.pascal.structured_statement#getConditional_statement <em>Conditional statement</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.pascal.structured_statement#getWith_statement <em>With statement</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl.pascal.PascalPackage#getstructured_statement()
 * @model
 * @generated
 */
public interface structured_statement extends EObject
{
   ...
   * @see org.xtext.example.mydsl.pascal.PascalPackage#getstructured_statement_Compound_statement()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.pascal.structured_statement#getCompound_statement <em>Compound statement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.pascal.PascalPackage#getstructured_statement_Repetitive_statement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.pascal.structured_statement#getRepetitive_statement <em>Repetitive statement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.pascal.PascalPackage#getstructured_statement_Conditional_statement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.pascal.structured_statement#getConditional_statement <em>Conditional statement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.pascal.PascalPackage#getstructured_statement_With_statement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.pascal.structured_statement#getWith_statement <em>With statement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
