 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.pascal.simple_expression#getSign <em>Sign</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.pascal.simple_expression#getTerm <em>Term</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.pascal.simple_expression#getAddition_operator <em>Addition operator</em>}</li>
 * </ul>
 *
...
public interface simple_expression extends EObject
{
   ...
   * @see #setSign(String)
   * @see org.xtext.example.mydsl.pascal.PascalPackage#getsimple_expression_Sign()
   * @model
   * @generated
   */
  String getSign();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.pascal.simple_expression#getSign <em>Sign</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.pascal.PascalPackage#getsimple_expression_Term()
   ...
   * The list contents are of type {@link org.xtext.example.mydsl.pascal.addition_operator}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.xtext.example.mydsl.pascal.PascalPackage#getsimple_expression_Addition_operator()
   * @model containment="true"
   * @generated
   */
