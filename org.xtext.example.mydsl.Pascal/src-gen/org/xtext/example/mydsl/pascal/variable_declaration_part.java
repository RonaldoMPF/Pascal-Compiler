 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.pascal.variable_declaration_part#getVariable_declaration <em>Variable declaration</em>}</li>
 * </ul>
 *
...
public interface variable_declaration_part extends EObject
{
   ...
   * @see org.xtext.example.mydsl.pascal.PascalPackage#getvariable_declaration_part_Variable_declaration()
