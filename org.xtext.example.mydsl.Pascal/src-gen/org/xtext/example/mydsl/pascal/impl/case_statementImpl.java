 ...
 *   <li>{@link org.xtext.example.mydsl.pascal.impl.case_statementImpl#getCase_limb <em>Case limb</em>}</li>
 * </ul>
 *
 * @generated
 */
public class case_statementImpl extends MinimalEObjectImpl.Container implements case_statement
{
  ...
  /**
   * The cached value of the '{@link #getCase_limb() <em>Case limb</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getCase_limb()
   * @generated
   * @ordered
   */
  protected EList<case_limb> case_limb;
   ...
   * @generated
   */
  public EList<case_limb> getCase_limb()
  {
    if (case_limb == null)
    {
      case_limb = new EObjectContainmentEList<case_limb>(case_limb.class, this, PascalPackage.CASE_STATEMENT__CASE_LIMB);
    }
    return case_limb;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case PascalPackage.CASE_STATEMENT__CASE_LIMB:
        return ((InternalEList<?>)getCase_limb()).basicRemove(otherEnd, msgs);
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case PascalPackage.CASE_STATEMENT__CASE_LIMB:
        getCase_limb().clear();
        getCase_limb().addAll((Collection<? extends case_limb>)newValue);
        return;
    }
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case PascalPackage.CASE_STATEMENT__CASE_LIMB:
        return case_limb != null && !case_limb.isEmpty();
    }
