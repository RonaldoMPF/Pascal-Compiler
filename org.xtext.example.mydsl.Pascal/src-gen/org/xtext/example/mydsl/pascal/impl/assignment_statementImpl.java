 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.pascal.impl.assignment_statementImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.pascal.impl.assignment_statementImpl#getFunction_identifier <em>Function identifier</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.pascal.impl.assignment_statementImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class assignment_statementImpl extends MinimalEObjectImpl.Container implements assignment_statement
{
  ...
  public NotificationChain basicSetFunction_identifier(identifier newFunction_identifier, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PascalPackage.ASSIGNMENT_STATEMENT__FUNCTION_IDENTIFIER, oldFunction_identifier, newFunction_identifier);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setFunction_identifier(identifier newFunction_identifier)
  {
    if (newFunction_identifier != function_identifier)
    {
      ...
      if (function_identifier != null)
        msgs = ((InternalEObject)function_identifier).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PascalPackage.ASSIGNMENT_STATEMENT__FUNCTION_IDENTIFIER, null, msgs);
      if (newFunction_identifier != null)
        msgs = ((InternalEObject)newFunction_identifier).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PascalPackage.ASSIGNMENT_STATEMENT__FUNCTION_IDENTIFIER, null, msgs);
      msgs = basicSetFunction_identifier(newFunction_identifier, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PascalPackage.ASSIGNMENT_STATEMENT__FUNCTION_IDENTIFIER, newFunction_identifier, newFunction_identifier));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case PascalPackage.ASSIGNMENT_STATEMENT__FUNCTION_IDENTIFIER:
