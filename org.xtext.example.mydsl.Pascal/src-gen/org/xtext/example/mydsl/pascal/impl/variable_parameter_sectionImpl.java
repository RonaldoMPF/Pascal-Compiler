 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.pascal.impl.variable_parameter_sectionImpl#getIdentifier_list <em>Identifier list</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.pascal.impl.variable_parameter_sectionImpl#getParameter_type <em>Parameter type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class variable_parameter_sectionImpl extends MinimalEObjectImpl.Container implements variable_parameter_section
{
  ...
  public NotificationChain basicSetIdentifier_list(identifier_list newIdentifier_list, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PascalPackage.VARIABLE_PARAMETER_SECTION__IDENTIFIER_LIST, oldIdentifier_list, newIdentifier_list);
  ...
  public void setIdentifier_list(identifier_list newIdentifier_list)
  {
    if (newIdentifier_list != identifier_list)
    {
      ...
      if (identifier_list != null)
        msgs = ((InternalEObject)identifier_list).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PascalPackage.VARIABLE_PARAMETER_SECTION__IDENTIFIER_LIST, null, msgs);
      if (newIdentifier_list != null)
        msgs = ((InternalEObject)newIdentifier_list).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PascalPackage.VARIABLE_PARAMETER_SECTION__IDENTIFIER_LIST, null, msgs);
      msgs = basicSetIdentifier_list(newIdentifier_list, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PascalPackage.VARIABLE_PARAMETER_SECTION__IDENTIFIER_LIST, newIdentifier_list, newIdentifier_list));
  }
  ...
  public NotificationChain basicSetParameter_type(parameter_type newParameter_type, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PascalPackage.VARIABLE_PARAMETER_SECTION__PARAMETER_TYPE, oldParameter_type, newParameter_type);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setParameter_type(parameter_type newParameter_type)
  {
    if (newParameter_type != parameter_type)
    {
      ...
      if (parameter_type != null)
        msgs = ((InternalEObject)parameter_type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PascalPackage.VARIABLE_PARAMETER_SECTION__PARAMETER_TYPE, null, msgs);
      if (newParameter_type != null)
        msgs = ((InternalEObject)newParameter_type).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PascalPackage.VARIABLE_PARAMETER_SECTION__PARAMETER_TYPE, null, msgs);
      msgs = basicSetParameter_type(newParameter_type, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PascalPackage.VARIABLE_PARAMETER_SECTION__PARAMETER_TYPE, newParameter_type, newParameter_type));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PascalPackage.VARIABLE_PARAMETER_SECTION__IDENTIFIER_LIST:
        return basicSetIdentifier_list(null, msgs);
      case PascalPackage.VARIABLE_PARAMETER_SECTION__PARAMETER_TYPE:
