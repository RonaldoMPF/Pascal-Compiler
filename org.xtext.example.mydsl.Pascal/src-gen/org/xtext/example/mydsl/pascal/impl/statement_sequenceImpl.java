 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.pascal.impl.statement_sequenceImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class statement_sequenceImpl extends MinimalEObjectImpl.Container implements statement_sequence
{
  ...
  public EList<statement> getStatement()
  {
    if (statement == null)
    {
      statement = new EObjectContainmentEList<statement>(statement.class, this, PascalPackage.STATEMENT_SEQUENCE__STATEMENT);
    }
    return statement;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PascalPackage.STATEMENT_SEQUENCE__STATEMENT:
