 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.pascal.impl.with_statementImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.pascal.impl.with_statementImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class with_statementImpl extends MinimalEObjectImpl.Container implements with_statement
{
  ...
  public EList<variable> getVariable()
  {
    if (variable == null)
    {
      variable = new EObjectContainmentEList<variable>(variable.class, this, PascalPackage.WITH_STATEMENT__VARIABLE);
    }
    return variable;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PascalPackage.WITH_STATEMENT__VARIABLE:
