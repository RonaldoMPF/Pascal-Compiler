 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.pascal.impl.label_declaration_partImpl#getLabel <em>Label</em>}</li>
 * </ul>
 *
 * @generated
 */
public class label_declaration_partImpl extends MinimalEObjectImpl.Container implements label_declaration_part
{
  ...
  public EList<label> getLabel()
  {
    if (label == null)
    {
      label = new EObjectContainmentEList<label>(label.class, this, PascalPackage.LABEL_DECLARATION_PART__LABEL);
    }
    return label;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PascalPackage.LABEL_DECLARATION_PART__LABEL:
