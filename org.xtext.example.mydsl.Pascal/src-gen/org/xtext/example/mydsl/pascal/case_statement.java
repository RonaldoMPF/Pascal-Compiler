 ...
 *   <li>{@link org.xtext.example.mydsl.pascal.case_statement#getCase_limb <em>Case limb</em>}</li>
 * </ul>
 *
...
public interface case_statement extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Case limb</b></em>' containment reference list.
   * The list contents are of type {@link org.xtext.example.mydsl.pascal.case_limb}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Case limb</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Case limb</em>' containment reference list.
   * @see org.xtext.example.mydsl.pascal.PascalPackage#getcase_statement_Case_limb()
   * @model containment="true"
   * @generated
   */
  EList<case_limb> getCase_limb();
