 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.pascal.case_label_list#getConstant <em>Constant</em>}</li>
 * </ul>
 *
...
public interface case_label_list extends EObject
{
   ...
   * @see org.xtext.example.mydsl.pascal.PascalPackage#getcase_label_list_Constant()
