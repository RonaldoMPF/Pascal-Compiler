 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.pascal.statement_sequence#getStatement <em>Statement</em>}</li>
 * </ul>
 *
...
public interface statement_sequence extends EObject
{
   ...
   * @see org.xtext.example.mydsl.pascal.PascalPackage#getstatement_sequence_Statement()
